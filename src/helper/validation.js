...
const validateSignup = (req) => {
    ...
    else if(req.body?.interest.length > 10) throw new Error("interest cannot have more than 10");
...
const validateUpdate = (req)=>{
    ...
    if(req.body?.interest.length > 10) throw new Error("interest cannot have more than 10");
